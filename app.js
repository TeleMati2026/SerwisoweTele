...
let customers=[],orders=[],prices=[],locations=[],orderHistory=[],selectedOrderId=null,inventoryProducts=[],inventoryMovements=[],orderParts=[],invoiceLines=[],calendarCursor=new Date(),calendarSelectedDate=new Date();
...
function fillOrderForm(order=null){
  ...
  if(order){
    ...
    $('orderWarranty').value=3;$('orderAcceptedDate').value=new Date().toISOString().slice(0,10);$('orderPriority').value='normal';$('orderEventType').value='repair';
  }
}
